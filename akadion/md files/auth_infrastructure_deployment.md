...
> [!TIP]
> În dezvoltare locală, poți crea un fișier numit `application-local.properties` în `../src/main/resources` (acesta este ignorat de Git) pentru a adăuga aceste variabile direct sub formă de proprietăți Spring, de exemplu:
> ```properties
